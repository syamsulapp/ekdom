...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/uho-min.png')}}" />
...
<body class="dashboard-analytics admin-header">
    ...
    @if(Route::has('login'))
    @auth
    <!-- header dan footer akan di jalankan setelah login-->
    <!-- header -->
    @include('tata_letak.header')
    <!-- konten-->
    @yield('konten')
    <!-- footer -->
    @include('tata_letak.footer')
    @else
    <!-- header dan footer tidak di jalankan sebelum login-->
    @yield('konten')
    @endauth
    @endif
